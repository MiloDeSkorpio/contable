          ...
          return (
            ...
            >
              <div 
                ...
                className={`${index === cardIndex && 'bg-white shadow-2xl'} w-[350px] h-[350px] bg-orange-200 flex flex-col items-center justify-center mx-auto p-[65px] text-center rounded-[12px] cursor-pointer transition-all`}
              >
                {/** card icon **/}
                <div className='mb-6'>
                ...
                {/** card img **/}
                {index === cardIndex && <img src={ArrowImg} alt='rowcard' />}
              </div>
            </div>
          )
        })}
